...
// astro dev serves public/ files but does not resolve a bare directory to its
// index.html the way the built site does, so address the file directly.
const APP = '/deutsch-woerter/index.html';
